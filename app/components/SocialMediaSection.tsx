...
const socialLinks = [
  { 
    ...
    hover: 'hover:text-[#0A66C2] hover:bg-white'
  },
  { 
    name: 'Instagram', 
    url: 'https://www.instagram.com/ditx.lmo/', 
    icon: <InstagramIcon className="w-5 h-5" />,
    hover: 'hover:text-[#E1306C] hover:bg-white'
  },
  { 
    name: 'WhatsApp', 
    url: 'https://wa.me/082123789852', 
    icon: <WhatsappIcon className="w-5 h-5" />,
    hover: 'hover:text-[#25D366] hover:bg-white'
  },
  { 
    name: 'TikTok', 
    url: 'https://www.tiktok.com/@adit.dev1?is_from_webapp=1&sender_device=pc', 
    icon: <TiktokIcon className="w-5 h-5" />,
    hover: 'hover:text-[#000000] hover:bg-white'
  },
];
