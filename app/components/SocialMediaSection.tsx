...
const socialLinks = [
  { 
    ...
    icon: <LinkedinIcon className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#0A66C2]" />
  },
  { 
    name: 'Instagram', 
    url: 'https://www.instagram.com/ditx.lmo/', 
    icon: <InstagramIcon className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#E4405F]" />
  },
  { 
    name: 'WhatsApp', 
    url: 'https://wa.me/082123789852', 
    icon: <WhatsappIcon className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#25D366]" />
  },
  { 
    name: 'TikTok', 
    url: 'https://www.tiktok.com/@adit.dev1?is_from_webapp=1&sender_device=pc', 
    icon: <TiktokIcon className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-black" />
  },
];
    ...
    <section className="py-20 px-4 sm:px-6 bg-white" ref={ref}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className={`text-zinc-600 mb-12 transition-all duration-700 
          ...
          Temukan saya di platform ini dan mari berkolaborasi
        </p>
